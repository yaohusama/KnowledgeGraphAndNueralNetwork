...
from data_parse_keywords import Data_Inter
...
class Bi_LSTM_Task:
    ...
    def add_placeholders(self):
        self.word_ids = tf.placeholder(tf.int32, shape=[self.batch_size, 7], name="word_ids")#7
    ...
    def predict_embedding(self):
        ...
        with tf.Session() as sess:
            ...
            # Test Stage
                ...
                # print(type(sentence_all))
                if "array" not in str(type(sentence_all)):
                    pickle.dump(feature, open("Source/keywords.pkl", "wb"))
                    print("predit done")
