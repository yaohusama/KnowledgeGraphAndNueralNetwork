...
# from bi_lstm_model_keywords import Bi_LSTM_Task
from bi_lstm_model_att import Bi_LSTM_Task
from DataProcess.dataset_info import info_org
from data_parse import DataParse, Data_Inter
class Config:
    def __init__(self):
        # self.root_data_path = 'data_path'
        self.root_data_path = r'model_save_org'
...
class Train:
    ...
    def __init__(self, model_name):
        ...
        self.au_vocab, self.key_vocab, self.au_len, self.key = info_org('DataProcess/data_manage_key_mapping.pkl')
    ...
    def train_and_eva(self):  # 越界。
        model = Bi_LSTM_Task(param_config=self.config,
                             ...
                             key_class=self.key,
                             embedding_dim=self.config.get_embedding_dim
